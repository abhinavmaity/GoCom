...
func (sh *SellerHandler) CreateSeller(c *gin.Context) {
	// Get user ID from JWT (placeholder for now)
	userID := sh.getUserIDFromContext(c)
	if userID == 0 {
...
// Helper to get user ID from JWT context (placeholder)
func (sh *SellerHandler) getUserIDFromContext(c *gin.Context) uint {
